.class final Lcom/biznessapps/layout/views/scanning/DecodeThread;
...
# direct methods
.method constructor <init>(Lcom/biznessapps/layout/views/scanning/AbstractCaptureActivity;Ljava/util/Vector;Ljava/lang/String;Lcom/google/zxing/ResultPointCallback;)V
    .locals 2
    ...
    .line 50
    iput-object p1, p0, Lcom/biznessapps/layout/views/scanning/DecodeThread;->activity:Lcom/biznessapps/layout/views/scanning/AbstractCaptureActivity;
    ...
    iput-object v0, p0, Lcom/biznessapps/layout/views/scanning/DecodeThread;->handlerInitLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    iput-object v0, p0, Lcom/biznessapps/layout/views/scanning/DecodeThread;->hints:Ljava/util/Hashtable;
    ...
    .line 69
    :cond_1
    iget-object v0, p0, Lcom/biznessapps/layout/views/scanning/DecodeThread;->hints:Ljava/util/Hashtable;
...
.method getHandler()Landroid/os/Handler;
    ...
    .line 85
    :try_start_0
    iget-object v0, p0, Lcom/biznessapps/layout/views/scanning/DecodeThread;->handlerInitLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    .line 89
    :goto_0
    iget-object v0, p0, Lcom/biznessapps/layout/views/scanning/DecodeThread;->handler:Landroid/os/Handler;
...
.method public run()V
    ...
    .line 98
    new-instance v0, Lcom/biznessapps/layout/views/scanning/DecodeHandler;

    iget-object v1, p0, Lcom/biznessapps/layout/views/scanning/DecodeThread;->activity:Lcom/biznessapps/layout/views/scanning/AbstractCaptureActivity;

    iget-object v2, p0, Lcom/biznessapps/layout/views/scanning/DecodeThread;->hints:Ljava/util/Hashtable;

    invoke-direct {v0, v1, v2}, Lcom/biznessapps/layout/views/scanning/DecodeHandler;-><init>(Lcom/biznessapps/layout/views/scanning/AbstractCaptureActivity;Ljava/util/Hashtable;)V

    iput-object v0, p0, Lcom/biznessapps/layout/views/scanning/DecodeThread;->handler:Landroid/os/Handler;
