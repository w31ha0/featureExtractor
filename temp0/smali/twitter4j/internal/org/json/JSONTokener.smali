...
.method public constructor <init>(Ljava/io/Reader;)V
    ...
    .line 55
    iput-boolean v1, p0, Ltwitter4j/internal/org/json/JSONTokener;->useLastChar:Z
...
.method public back()V
    ...
    .prologue
    .line 76
    iget-boolean v0, p0, Ltwitter4j/internal/org/json/JSONTokener;->useLastChar:Z
    ...
    iput-boolean v0, p0, Ltwitter4j/internal/org/json/JSONTokener;->useLastChar:Z
...
.method public next()C
    ...
    .line 126
    iget-boolean v3, p0, Ltwitter4j/internal/org/json/JSONTokener;->useLastChar:Z

    if-eqz v3, :cond_1

    .line 127
    iput-boolean v2, p0, Ltwitter4j/internal/org/json/JSONTokener;->useLastChar:Z

    .line 128
    iget-char v2, p0, Ltwitter4j/internal/org/json/JSONTokener;->lastChar:C

    if-eqz v2, :cond_0

    .line 129
    iget v2, p0, Ltwitter4j/internal/org/json/JSONTokener;->index:I

    add-int/lit8 v2, v2, 0x1

    iput v2, p0, Ltwitter4j/internal/org/json/JSONTokener;->index:I
    ...
    :cond_1
    :try_start_0
    iget-object v3, p0, Ltwitter4j/internal/org/json/JSONTokener;->reader:Ljava/io/Reader;
    ...
    .line 141
    iput-char v2, p0, Ltwitter4j/internal/org/json/JSONTokener;->lastChar:C
...
.method public next(I)Ljava/lang/String;
    ...
    .line 184
    .local v3, "pos":I
    iget-boolean v4, p0, Ltwitter4j/internal/org/json/JSONTokener;->useLastChar:Z

    if-eqz v4, :cond_1

    .line 185
    iput-boolean v5, p0, Ltwitter4j/internal/org/json/JSONTokener;->useLastChar:Z

    .line 186
    iget-char v4, p0, Ltwitter4j/internal/org/json/JSONTokener;->lastChar:C
    ...
    .line 196
    .local v1, "exc":Ljava/io/IOException;
    new-instance v4, Ltwitter4j/internal/org/json/JSONException;

    invoke-direct {v4, v1}, Ltwitter4j/internal/org/json/JSONException;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v4}, Ltwitter4j/internal/org/json/JSONTokener;->syntaxError(Ljava/lang/String;)Ltwitter4j/internal/org/json/JSONException;
    ...
    iput-char v4, p0, Ltwitter4j/internal/org/json/JSONTokener;->lastChar:C
...
.method public nextValue()Ljava/lang/Object;
    ...
    .line 371
    :cond_1
    invoke-static {v1}, Ltwitter4j/internal/org/json/JSONObject;->stringToValue(Ljava/lang/String;)Ljava/lang/Object;
...
.method public skipTo(C)C
    ...
    invoke-direct {v3, v1}, Ltwitter4j/internal/org/json/JSONException;-><init>(Ljava/lang/Throwable;)V
