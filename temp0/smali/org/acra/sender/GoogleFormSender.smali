...
.method private remap(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-interface {v7}, Lorg/acra/annotation/ReportsCrashes;->customReportContent()[Lorg/acra/ReportField;
    ...
    sget-object v8, Lorg/acra/sender/GoogleFormSender$1;->$SwitchMap$org$acra$ReportField:[I

    move-object v7, v5

    check-cast v7, Lorg/acra/ReportField;

    invoke-virtual {v7}, Lorg/acra/ReportField;->ordinal()I
...
.method public send(Lorg/acra/CrashReportData;)V
    ...
    iget-object v3, p0, Lorg/acra/sender/GoogleFormSender;->mFormUri:Landroid/net/Uri;
    ...
    const-string v4, "Error while sending report to Google Form."
