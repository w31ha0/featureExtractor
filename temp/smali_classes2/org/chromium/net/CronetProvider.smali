...
.method private static addCronetProviderFromResourceFile(Landroid/content/Context;Ljava/util/List;)Z
    ...
    const-string/jumbo v2, "CronetProviderClassName"
    ...
    .line 204
    invoke-static {p0, v1, p1, v0}, Lorg/chromium/net/CronetProvider;->addCronetProviderImplByClassName(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;Z)Z
    ...
    const-string/jumbo v3, "Unable to instantiate Cronet implementation class "
    ...
    const-string/jumbo v2, " that is listed as in the app string resource file under "
...
.method public static getAllProviders(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 132
    const-string/jumbo v1, "org.chromium.net.impl.NativeCronetProvider"

    invoke-static {p0, v1, v0, v2}, Lorg/chromium/net/CronetProvider;->addCronetProviderImplByClassName(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;Z)Z

    .line 133
    const-string/jumbo v1, "org.chromium.net.impl.JavaCronetProvider"
...
.method private static logReflectiveOperationException(Ljava/lang/String;ZLjava/lang/Exception;)V
    ...
    const-string/jumbo v2, "Unable to load provider class: "
    ...
    const-string/jumbo v2, "Tried to load "
    ...
    const-string/jumbo v2, " provider class but it wasn\'t"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, " included in the app classpath"
