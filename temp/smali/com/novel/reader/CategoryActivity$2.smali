.class Lcom/novel/reader/CategoryActivity$2;
...
# direct methods
.method constructor <init>(Lcom/novel/reader/CategoryActivity;Landroid/view/Menu;Landroid/view/MenuItem;Landroid/support/v7/widget/SearchView;)V
    .locals 0
    .param p1, "this$0"    # Lcom/novel/reader/CategoryActivity;

    .prologue
    .line 140
    iput-object p1, p0, Lcom/novel/reader/CategoryActivity$2;->this$0:Lcom/novel/reader/CategoryActivity;

    iput-object p2, p0, Lcom/novel/reader/CategoryActivity$2;->val$menu:Landroid/view/Menu;

    iput-object p3, p0, Lcom/novel/reader/CategoryActivity$2;->val$searchMenuItem:Landroid/view/MenuItem;

    iput-object p4, p0, Lcom/novel/reader/CategoryActivity$2;->val$searchView:Landroid/support/v7/widget/SearchView;
...
.method public onFocusChange(Landroid/view/View;Z)V
    ...
    iget-object v2, p0, Lcom/novel/reader/CategoryActivity$2;->this$0:Lcom/novel/reader/CategoryActivity;

    invoke-direct {v0, v2}, Lcom/novel/db/SQLiteNovel;-><init>(Landroid/content/Context;)V

    .line 145
    .local v0, "db":Lcom/novel/db/SQLiteNovel;
    iget-object v2, p0, Lcom/novel/reader/CategoryActivity$2;->val$menu:Landroid/view/Menu;
    ...
    iget-object v3, p0, Lcom/novel/reader/CategoryActivity$2;->this$0:Lcom/novel/reader/CategoryActivity;
    ...
    .line 148
    :cond_0
    iget-object v2, p0, Lcom/novel/reader/CategoryActivity$2;->val$searchMenuItem:Landroid/view/MenuItem;

    invoke-interface {v2}, Landroid/view/MenuItem;->collapseActionView()Z

    .line 149
    iget-object v2, p0, Lcom/novel/reader/CategoryActivity$2;->val$searchView:Landroid/support/v7/widget/SearchView;
