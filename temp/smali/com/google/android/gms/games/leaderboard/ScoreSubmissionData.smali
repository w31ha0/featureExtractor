...
.method public constructor <init>(Lcom/google/android/gms/common/data/DataHolder;)V
    ...
    iput v0, p0, Lcom/google/android/gms/games/leaderboard/ScoreSubmissionData;->zzTS:I

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/games/leaderboard/ScoreSubmissionData;->zzauc:Ljava/util/HashMap;
    ...
    invoke-virtual {p1, v6}, Lcom/google/android/gms/common/data/DataHolder;->zzbh(I)I
    ...
    invoke-virtual {p1, v0, v6, v8}, Lcom/google/android/gms/common/data/DataHolder;->zzd(Ljava/lang/String;II)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/games/leaderboard/ScoreSubmissionData;->zzaty:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/google/android/gms/games/leaderboard/ScoreSubmissionData;->zzTL:Ljava/lang/String;

    :cond_0
    const-string v0, "hasResult"

    invoke-virtual {p1, v0, v6, v8}, Lcom/google/android/gms/common/data/DataHolder;->zze(Ljava/lang/String;II)Z
    ...
    invoke-virtual {p1, v1, v6, v8}, Lcom/google/android/gms/common/data/DataHolder;->zzb(Ljava/lang/String;II)J

    move-result-wide v1

    const-string v3, "formattedScore"

    invoke-virtual {p1, v3, v6, v8}, Lcom/google/android/gms/common/data/DataHolder;->zzd(Ljava/lang/String;II)Ljava/lang/String;

    move-result-object v3

    const-string v4, "scoreTag"

    invoke-virtual {p1, v4, v6, v8}, Lcom/google/android/gms/common/data/DataHolder;->zzd(Ljava/lang/String;II)Ljava/lang/String;

    move-result-object v4

    const-string v5, "newBest"

    invoke-virtual {p1, v5, v6, v8}, Lcom/google/android/gms/common/data/DataHolder;->zze(Ljava/lang/String;II)Z
    ...
    invoke-virtual {p1, v1, v6, v8}, Lcom/google/android/gms/common/data/DataHolder;->zzc(Ljava/lang/String;II)I

    move-result v1

    invoke-direct {p0, v0, v1}, Lcom/google/android/gms/games/leaderboard/ScoreSubmissionData;->zza(Lcom/google/android/gms/games/leaderboard/ScoreSubmissionData$Result;I)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/android/gms/games/leaderboard/ScoreSubmissionData;->zzTL:Ljava/lang/String;
    ...
    iget v2, p0, Lcom/google/android/gms/games/leaderboard/ScoreSubmissionData;->zzTS:I
    ...
    invoke-virtual {v2, v3, v4}, Lcom/google/android/gms/common/internal/zzt$zza;->zzg(Ljava/lang/String;Ljava/lang/Object;)Lcom/google/android/gms/common/internal/zzt$zza;
    ...
    :goto_1
    invoke-virtual {v2, v3, v0}, Lcom/google/android/gms/common/internal/zzt$zza;->zzg(Ljava/lang/String;Ljava/lang/Object;)Lcom/google/android/gms/common/internal/zzt$zza;
    ...
    :cond_1
    invoke-virtual {v2}, Lcom/google/android/gms/common/internal/zzt$zza;->toString()Ljava/lang/String;
