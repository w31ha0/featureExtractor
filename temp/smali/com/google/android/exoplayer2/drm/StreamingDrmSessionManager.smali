...
.method public constructor <init>(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/ExoMediaDrm;Lcom/google/android/exoplayer2/drm/MediaDrmCallback;Ljava/util/HashMap;Landroid/os/Handler;Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$EventListener;)V
    ...
    .param p6, "eventListener"    # Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$EventListener;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/UUID;",
    ...
    .prologue
    .line 173
    .local p0, "this":Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;, "Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager<TT;>;"
...
.method static synthetic access$100(Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;)Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$EventListener;
    .locals 1
    .param p0, "x0"    # Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;
...
.method public static newFrameworkInstance(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/MediaDrmCallback;Ljava/util/HashMap;Landroid/os/Handler;Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$EventListener;)Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;
    ...
    .param p4, "eventListener"    # Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$EventListener;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/UUID;",
...
.method public static newPlayReadyInstance(Lcom/google/android/exoplayer2/drm/MediaDrmCallback;Ljava/lang/String;Landroid/os/Handler;Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$EventListener;)Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;
    ...
    .param p3, "eventListener"    # Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$EventListener;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/google/android/exoplayer2/drm/MediaDrmCallback;",
...
.method private onKeyResponse(Ljava/lang/Object;)V
    ...
    .line 385
    iget v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->state:I
    ...
    :cond_2
    :try_start_0
    iget-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->mediaDrm:Lcom/google/android/exoplayer2/drm/ExoMediaDrm;
    ...
    invoke-interface {v1, v2, p1}, Lcom/google/android/exoplayer2/drm/ExoMediaDrm;->provideKeyResponse([B[B)[B

    .line 397
    const/4 v1, 0x4

    iput v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->state:I

    .line 398
    iget-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->eventHandler:Landroid/os/Handler;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->eventListener:Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$EventListener;
    ...
    new-instance v2, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$1;

    invoke-direct {v2, p0}, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$1;-><init>(Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;)V
...
.method private onProvisionResponse(Ljava/lang/Object;)V
    ...
    .line 350
    iput-boolean v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->provisioningInProgress:Z
...
.method private openInternal(Z)V
    ...
    iput-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->sessionId:[B
    ...
    iget-object v3, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->sessionId:[B
    ...
    iput-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->mediaCrypto:Lcom/google/android/exoplayer2/drm/ExoMediaCrypto;
...
.method private postKeyRequest()V
    ...
    invoke-direct {p0, v6}, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->onKeysError(Ljava/lang/Exception;)V
...
.method private postProvisionRequest()V
    ...
    .line 341
    .local p0, "this":Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;, "Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager<TT;>;"
    iget-boolean v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->provisioningInProgress:Z
...
.method public acquireSession(Landroid/os/Looper;Lcom/google/android/exoplayer2/drm/DrmInitData;)Lcom/google/android/exoplayer2/drm/DrmSession;
    ...
    .line 236
    iget-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->playbackLooper:Landroid/os/Looper;
    ...
    .line 237
    iget v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->openCount:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->openCount:I
    ...
    .line 243
    new-instance v1, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$MediaDrmHandler;

    invoke-direct {v1, p0, p1}, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$MediaDrmHandler;-><init>(Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->mediaDrmHandler:Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$MediaDrmHandler;

    .line 244
    new-instance v1, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$PostResponseHandler;

    invoke-direct {v1, p0, p1}, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$PostResponseHandler;-><init>(Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->postResponseHandler:Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$PostResponseHandler;
    ...
    iput-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->requestHandlerThread:Landroid/os/HandlerThread;

    .line 248
    iget-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->requestHandlerThread:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->start()V

    .line 249
    new-instance v1, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$PostRequestHandler;

    iget-object v3, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->requestHandlerThread:Landroid/os/HandlerThread;

    invoke-virtual {v3}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v3

    invoke-direct {v1, p0, v3}, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager$PostRequestHandler;-><init>(Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->postRequestHandler:Landroid/os/Handler;

    .line 251
    iget-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->uuid:Ljava/util/UUID;

    invoke-virtual {p2, v1}, Lcom/google/android/exoplayer2/drm/DrmInitData;->get(Ljava/util/UUID;)Lcom/google/android/exoplayer2/drm/DrmInitData$SchemeData;

    move-result-object v1

    iput-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->schemeData:Lcom/google/android/exoplayer2/drm/DrmInitData$SchemeData;

    .line 252
    iget-object v1, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->schemeData:Lcom/google/android/exoplayer2/drm/DrmInitData$SchemeData;
    ...
    iget-object v3, p0, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->uuid:Ljava/util/UUID;
    ...
    invoke-direct {p0, v1}, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->onError(Ljava/lang/Exception;)V
    ...
    invoke-static {v1, v3}, Lcom/google/android/exoplayer2/extractor/mp4/PsshAtomUtil;->parseSchemeSpecificData([BLjava/util/UUID;)[B
    ...
    .line 266
    invoke-direct {p0, v2}, Lcom/google/android/exoplayer2/drm/StreamingDrmSessionManager;->openInternal(Z)V
    ...
    invoke-direct {v1, v3, v4, v0}, Lcom/google/android/exoplayer2/drm/DrmInitData$SchemeData;-><init>(Ljava/util/UUID;Ljava/lang/String;[B)V
