...
.method public static a(Lc;Ld;)V
    .locals 4
...
.method public onCompletion(Landroid/media/MediaPlayer;)V
    ...
    invoke-virtual {v0, v1}, Lb;->loadUrl(Ljava/lang/String;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    sget-object v8, Lcom/google/ads/AdActivity;->c:Lc;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {v2, v1}, Ld;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v2}, Ld;->b()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v2}, Ld;->c()Ljava/util/HashMap;
    ...
    iput-object v6, p0, Lcom/google/ads/AdActivity;->f:Lb;
    ...
    sget-object v3, Lcom/google/ads/AdActivity;->c:Lc;

    if-eqz v3, :cond_a

    sget-object v3, Lcom/google/ads/AdActivity;->c:Lc;

    invoke-virtual {v3}, Lc;->r()V
    ...
    invoke-static {v2, v1}, Lcom/google/ads/util/d;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v3}, Lcom/google/ads/util/d;->e(Ljava/lang/String;)V
    :try_end_4
    ...
    invoke-direct {v1, v2, v6}, Lb;-><init>(Landroid/content/Context;Lcom/google/ads/f;)V

    iput-object v1, p0, Lcom/google/ads/AdActivity;->f:Lb;

    new-instance v1, Ln;

    sget-object v2, Lg;->b:Ljava/util/Map;

    invoke-direct {v1, v8, v2, v9, v9}, Ln;-><init>(Lc;Ljava/util/Map;ZZ)V

    invoke-virtual {v1}, Ln;->b()V

    iget-object v2, p0, Lcom/google/ads/AdActivity;->f:Lb;

    invoke-virtual {v2, v1}, Lb;->setWebViewClient(Landroid/webkit/WebViewClient;)V
    ...
    invoke-virtual {v2, v1}, Lb;->loadUrl(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2, v10, v1}, Lcom/google/ads/AdActivity;->a(Lb;ZI)V
    ...
    invoke-virtual/range {v1 .. v6}, Lb;->loadDataWithBaseURL(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2, v9, v1}, Lcom/google/ads/AdActivity;->a(Lb;ZI)V
