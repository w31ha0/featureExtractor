...
.method protected final addClickTrackers(Ljava/lang/Object;)V
    ...
    const-string v4, "Expected click trackers of type JSONArray."
    ...
    invoke-virtual {p0, v3}, Lcom/mopub/nativeads/BaseNativeAd;->addClickTracker(Ljava/lang/String;)V
    :try_end_0
    ...
    const-string v3, "Unable to parse click trackers."
...
.method protected final addImpressionTrackers(Ljava/lang/Object;)V
    .locals 5
    .param p1, "impressionTrackers"    # Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/ClassCastException;
        }
    ...
    const-string v4, "Expected impression trackers of type JSONArray."
    ...
    invoke-virtual {p0, v3}, Lcom/mopub/nativeads/BaseNativeAd;->addImpressionTracker(Ljava/lang/String;)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 102
    .local v0, "e":Lorg/json/JSONException;
    const-string v3, "Unable to parse impression trackers."
...
.method public setNativeEventListener(Lcom/mopub/nativeads/BaseNativeAd$NativeEventListener;)V
    .locals 0
    .param p1, "nativeEventListener"    # Lcom/mopub/nativeads/BaseNativeAd$NativeEventListener;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
