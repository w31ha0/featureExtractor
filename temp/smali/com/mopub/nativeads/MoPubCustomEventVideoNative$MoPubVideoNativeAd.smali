...
.method public onVastVideoConfigurationPrepared(Lcom/mopub/mobileads/VastVideoConfig;)V
    ...
    iget-object v3, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mCustomEventNativeListener:Lcom/mopub/nativeads/CustomEventNative$CustomEventNativeListener;

    sget-object v4, Lcom/mopub/nativeads/NativeErrorCode;->INVALID_RESPONSE:Lcom/mopub/nativeads/NativeErrorCode;

    invoke-interface {v3, v4}, Lcom/mopub/nativeads/CustomEventNative$CustomEventNativeListener;->onNativeAdFailed(Lcom/mopub/nativeads/NativeErrorCode;)V
    ...
    .line 301
    .local v7, "visibilityTrackingEvents":Ljava/util/List;, "Ljava/util/List<Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;>;"
    new-instance v17, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;

    invoke-direct/range {v17 .. v17}, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;-><init>()V

    .line 302
    .local v17, "visibilityTrackingEvent":Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;
    new-instance v3, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$HeaderVisibilityStrategy;

    move-object/from16 v0, p0

    invoke-direct {v3, v0}, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$HeaderVisibilityStrategy;-><init>(Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;)V

    move-object/from16 v0, v17

    iput-object v3, v0, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;->strategy:Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent$OnTrackedStrategy;

    .line 303
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mVideoResponseHeaders:Lcom/mopub/nativeads/MoPubCustomEventVideoNative$VideoResponseHeaders;
    ...
    iput v3, v0, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;->minimumPercentageVisible:I
    ...
    iput v3, v0, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;->totalRequiredPlayTimeMs:I
    ...
    .line 310
    invoke-virtual/range {p1 .. p1}, Lcom/mopub/mobileads/VastVideoConfig;->getImpressionTrackers()Ljava/util/List;
    ...
    check-cast v13, Lcom/mopub/mobileads/VastTracker;

    .line 311
    .local v13, "vastTracker":Lcom/mopub/mobileads/VastTracker;
    ...
    .line 313
    .local v12, "vastImpressionTrackingEvent":Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;
    new-instance v4, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$PayloadVisibilityStrategy;

    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mContext:Landroid/content/Context;

    .line 314
    invoke-virtual {v13}, Lcom/mopub/mobileads/VastTracker;->getTrackingUrl()Ljava/lang/String;

    move-result-object v6

    invoke-direct {v4, v5, v6}, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$PayloadVisibilityStrategy;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v4, v12, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;->strategy:Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent$OnTrackedStrategy;

    .line 315
    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mVideoResponseHeaders:Lcom/mopub/nativeads/MoPubCustomEventVideoNative$VideoResponseHeaders;

    .line 316
    invoke-virtual {v4}, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$VideoResponseHeaders;->getImpressionMinVisiblePercent()I

    move-result v4

    iput v4, v12, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;->minimumPercentageVisible:I
    ...
    .line 318
    invoke-virtual {v4}, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$VideoResponseHeaders;->getImpressionVisibleMs()I

    move-result v4

    iput v4, v12, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;->totalRequiredPlayTimeMs:I
    ...
    .line 323
    .end local v12    # "vastImpressionTrackingEvent":Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;
    .end local v13    # "vastTracker":Lcom/mopub/mobileads/VastTracker;
    :cond_2
    move-object/from16 v0, p1

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mVastVideoConfig:Lcom/mopub/mobileads/VastVideoConfig;

    .line 324
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mVastVideoConfig:Lcom/mopub/mobileads/VastVideoConfig;

    .line 325
    invoke-virtual {v3}, Lcom/mopub/mobileads/VastVideoConfig;->getVideoViewabilityTracker()Lcom/mopub/mobileads/VideoViewabilityTracker;

    move-result-object v14

    .line 326
    .local v14, "vastVideoViewabilityTracker":Lcom/mopub/mobileads/VideoViewabilityTracker;
    if-eqz v14, :cond_3

    .line 327
    new-instance v15, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;

    invoke-direct {v15}, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;-><init>()V

    .line 329
    .local v15, "vastVisibilityTrackingEvent":Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;
    new-instance v3, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$PayloadVisibilityStrategy;

    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mContext:Landroid/content/Context;

    .line 331
    invoke-virtual {v14}, Lcom/mopub/mobileads/VideoViewabilityTracker;->getTrackingUrl()Ljava/lang/String;
    ...
    iput-object v3, v15, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;->strategy:Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent$OnTrackedStrategy;

    .line 333
    invoke-virtual {v14}, Lcom/mopub/mobileads/VideoViewabilityTracker;->getPercentViewable()I

    move-result v3

    iput v3, v15, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;->minimumPercentageVisible:I

    .line 335
    invoke-virtual {v14}, Lcom/mopub/mobileads/VideoViewabilityTracker;->getViewablePlaytimeMS()I

    move-result v3

    iput v3, v15, Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;->totalRequiredPlayTimeMs:I

    .line 336
    invoke-interface {v7, v15}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 339
    .end local v15    # "vastVisibilityTrackingEvent":Lcom/mopub/nativeads/NativeVideoController$VisibilityTrackingEvent;
    :cond_3
    ...
    .line 340
    .local v2, "clickTrackers":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mMoPubClickTrackingUrl:Ljava/lang/String;

    invoke-interface {v2, v3}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    .line 341
    invoke-virtual/range {p0 .. p0}, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->getClickTrackers()Ljava/util/Set;
    ...
    .line 344
    .local v11, "vastClickTrackers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/mopub/mobileads/VastTracker;>;"
    invoke-interface {v2}, Ljava/util/Set;->iterator()Ljava/util/Iterator;
    ...
    .line 345
    .local v10, "clickTrackingUrl":Ljava/lang/String;
    new-instance v4, Lcom/mopub/mobileads/VastTracker;

    const/4 v5, 0x0

    invoke-direct {v4, v10, v5}, Lcom/mopub/mobileads/VastTracker;-><init>(Ljava/lang/String;Z)V
    ...
    .line 347
    .end local v10    # "clickTrackingUrl":Ljava/lang/String;
    :cond_4
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mVastVideoConfig:Lcom/mopub/mobileads/VastVideoConfig;

    invoke-virtual {v3, v11}, Lcom/mopub/mobileads/VastVideoConfig;->addClickTrackers(Ljava/util/List;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->getClickDestinationUrl()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/mopub/mobileads/VastVideoConfig;->setClickThroughUrl(Ljava/lang/String;)V

    .line 352
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mNativeVideoControllerFactory:Lcom/mopub/nativeads/MoPubCustomEventVideoNative$NativeVideoControllerFactory;

    move-object/from16 v0, p0

    iget-wide v4, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mId:J

    move-object/from16 v0, p0

    iget-object v6, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mContext:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v8, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mVastVideoConfig:Lcom/mopub/mobileads/VastVideoConfig;

    move-object/from16 v0, p0

    iget-object v9, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mEventDetails:Lcom/mopub/common/event/EventDetails;

    invoke-virtual/range {v3 .. v9}, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$NativeVideoControllerFactory;->createForId(JLandroid/content/Context;Ljava/util/List;Lcom/mopub/mobileads/VastVideoConfig;Lcom/mopub/common/event/EventDetails;)Lcom/mopub/nativeads/NativeVideoController;

    move-result-object v3

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$MoPubVideoNativeAd;->mNativeVideoController:Lcom/mopub/nativeads/NativeVideoController;
    ...
    invoke-interface {v3, v0}, Lcom/mopub/nativeads/CustomEventNative$CustomEventNativeListener;->onNativeAdLoaded(Lcom/mopub/nativeads/BaseNativeAd;)V
    ...
    invoke-virtual {v3}, Lcom/mopub/nativeads/MoPubCustomEventVideoNative$VideoResponseHeaders;->getVideoTrackers()Lorg/json/JSONObject;

    move-result-object v16

    .line 359
    .local v16, "videoTrackers":Lorg/json/JSONObject;
    if-eqz v16, :cond_0
    ...
    invoke-virtual {v3, v0}, Lcom/mopub/mobileads/VastVideoConfig;->addVideoTrackers(Lorg/json/JSONObject;)V
