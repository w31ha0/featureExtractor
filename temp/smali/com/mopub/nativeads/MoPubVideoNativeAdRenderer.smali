...
.method private setViewVisibility(Lcom/mopub/nativeads/MediaViewHolder;I)V
    .locals 1
    .param p1, "mediaViewHolder"    # Lcom/mopub/nativeads/MediaViewHolder;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
...
.method private update(Lcom/mopub/nativeads/MediaViewHolder;Lcom/mopub/nativeads/VideoNativeAd;)V
    ...
    .param p1, "mediaViewHolder"    # Lcom/mopub/nativeads/MediaViewHolder;
        ...
        .end annotation
    .end param
    .param p2, "videoNativeAd"    # Lcom/mopub/nativeads/VideoNativeAd;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
...
.method public renderAdView(Landroid/view/View;Lcom/mopub/nativeads/VideoNativeAd;)V
    ...
    .prologue
    .line 46
    iget-object v2, p0, Lcom/mopub/nativeads/MoPubVideoNativeAdRenderer;->mMediaViewHolderMap:Ljava/util/WeakHashMap;

    invoke-virtual {v2, p1}, Ljava/util/WeakHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/mopub/nativeads/MediaViewHolder;
    ...
    invoke-static {p1, v2}, Lcom/mopub/nativeads/MediaViewHolder;->fromViewBinder(Landroid/view/View;Lcom/mopub/nativeads/MediaViewBinder;)Lcom/mopub/nativeads/MediaViewHolder;
    ...
    .line 52
    :cond_0
    invoke-direct {p0, v1, p2}, Lcom/mopub/nativeads/MoPubVideoNativeAdRenderer;->update(Lcom/mopub/nativeads/MediaViewHolder;Lcom/mopub/nativeads/VideoNativeAd;)V

    .line 53
    iget-object v2, v1, Lcom/mopub/nativeads/MediaViewHolder;->mainView:Landroid/view/View;

    iget-object v3, p0, Lcom/mopub/nativeads/MoPubVideoNativeAdRenderer;->mMediaViewBinder:Lcom/mopub/nativeads/MediaViewBinder;

    iget-object v3, v3, Lcom/mopub/nativeads/MediaViewBinder;->extras:Ljava/util/Map;
    ...
    invoke-direct {p0, v1, v2}, Lcom/mopub/nativeads/MoPubVideoNativeAdRenderer;->setViewVisibility(Lcom/mopub/nativeads/MediaViewHolder;I)V

    .line 56
    iget-object v2, p0, Lcom/mopub/nativeads/MoPubVideoNativeAdRenderer;->mMediaViewBinder:Lcom/mopub/nativeads/MediaViewBinder;

    iget v2, v2, Lcom/mopub/nativeads/MediaViewBinder;->mediaLayoutId:I
    ...
    .line 57
    .local v0, "mediaLayout":Lcom/mopub/nativeads/MediaLayout;
