...
.method public getAdView(Landroid/view/View;Landroid/view/ViewGroup;Lcom/mopub/nativeads/NativeAd;)Landroid/view/View;
    ...
    .param p2, "parent"    # Landroid/view/ViewGroup;
        ...
        .end annotation
    .end param
    .param p3, "nativeAd"    # Lcom/mopub/nativeads/NativeAd;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
    .annotation build Landroid/support/annotation/NonNull;
...
.method public getAdView(Landroid/view/View;Landroid/view/ViewGroup;Lcom/mopub/nativeads/NativeAd;Lcom/mopub/nativeads/ViewBinder;)Landroid/view/View;
    ...
    .param p3, "nativeAd"    # Lcom/mopub/nativeads/NativeAd;
        ...
        .end annotation
    .end param
    .param p4, "viewBinder"    # Lcom/mopub/nativeads/ViewBinder;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
    .annotation build Landroid/support/annotation/NonNull;
    ...
    .prologue
    .line 47
    iget-object v1, p0, Lcom/mopub/nativeads/AdapterHelper;->mContext:Ljava/lang/ref/WeakReference;
    ...
    .line 49
    const-string v1, "Weak reference to Context in AdapterHelper became null. Returning empty view."
    ...
    iget-object v2, p0, Lcom/mopub/nativeads/AdapterHelper;->mApplicationContext:Landroid/content/Context;
