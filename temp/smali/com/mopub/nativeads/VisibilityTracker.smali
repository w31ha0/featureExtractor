...
.method constructor <init>(Landroid/content/Context;Ljava/util/Map;Lcom/mopub/nativeads/VisibilityTracker$VisibilityChecker;Landroid/os/Handler;)V
    ...
    .param p2    # Ljava/util/Map;
        ...
        .end annotation
    .end param
    .param p3, "visibilityChecker"    # Lcom/mopub/nativeads/VisibilityTracker$VisibilityChecker;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    .param p4, "visibilityHandler"    # Landroid/os/Handler;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Lcom/mopub/common/VisibleForTesting;
    ...
    .prologue
    .local p2, "trackedViews":Ljava/util/Map;, "Ljava/util/Map<Landroid/view/View;Lcom/mopub/nativeads/VisibilityTracker$TrackingInfo;>;"
    const/4 v2, 0x0
...
.method static synthetic access$002(Lcom/mopub/nativeads/VisibilityTracker;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/mopub/nativeads/VisibilityTracker;
    .param p1, "x1"    # Z
...
.method private setViewTreeObserver(Landroid/content/Context;Landroid/view/View;)V
    ...
    .prologue
    .line 108
    iget-object v3, p0, Lcom/mopub/nativeads/VisibilityTracker;->mWeakViewTreeObserver:Ljava/lang/ref/WeakReference;
    ...
    iput-object v3, p0, Lcom/mopub/nativeads/VisibilityTracker;->mWeakViewTreeObserver:Ljava/lang/ref/WeakReference;

    .line 127
    iget-object v3, p0, Lcom/mopub/nativeads/VisibilityTracker;->mOnPreDrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method private trimTrackedViews(J)V
    .locals 7
    .param p1, "minAccessOrder"    # J

    .prologue
    .line 173
    iget-object v2, p0, Lcom/mopub/nativeads/VisibilityTracker;->mTrackedViews:Ljava/util/Map;
    ...
    iget-wide v4, v2, Lcom/mopub/nativeads/VisibilityTracker$TrackingInfo;->mAccessOrder:J
    ...
    invoke-virtual {p0, v1}, Lcom/mopub/nativeads/VisibilityTracker;->removeView(Landroid/view/View;)V
...
.method addView(Landroid/view/View;I)V
    ...
    .param p1, "view"    # Landroid/view/View;
        ...
        .end annotation
    .end param
    .param p2, "minPercentageViewed"    # I
...
.method addView(Landroid/view/View;Landroid/view/View;II)V
    ...
    .param p2, "view"    # Landroid/view/View;
        ...
        .end annotation
    .end param
    .param p3, "minVisiblePercentageViewed"    # I
    .param p4, "maxInvisiblePercentageViewed"    # I
    ...
    invoke-direct {p0, v2, p2}, Lcom/mopub/nativeads/VisibilityTracker;->setViewTreeObserver(Landroid/content/Context;Landroid/view/View;)V
    ...
    .line 151
    .local v1, "trackingInfo":Lcom/mopub/nativeads/VisibilityTracker$TrackingInfo;
    if-nez v1, :cond_0

    .line 152
    new-instance v1, Lcom/mopub/nativeads/VisibilityTracker$TrackingInfo;

    .end local v1    # "trackingInfo":Lcom/mopub/nativeads/VisibilityTracker$TrackingInfo;
    invoke-direct {v1}, Lcom/mopub/nativeads/VisibilityTracker$TrackingInfo;-><init>()V

    .line 153
    .restart local v1    # "trackingInfo":Lcom/mopub/nativeads/VisibilityTracker$TrackingInfo;
    iget-object v2, p0, Lcom/mopub/nativeads/VisibilityTracker;->mTrackedViews:Ljava/util/Map;
    ...
    .line 159
    .local v0, "maxInvisiblePercent":I
    iput-object p1, v1, Lcom/mopub/nativeads/VisibilityTracker$TrackingInfo;->mRootView:Landroid/view/View;

    .line 160
    iput p3, v1, Lcom/mopub/nativeads/VisibilityTracker$TrackingInfo;->mMinViewablePercent:I

    .line 161
    iput v0, v1, Lcom/mopub/nativeads/VisibilityTracker$TrackingInfo;->mMaxInvisiblePercent:I

    .line 162
    iget-wide v2, p0, Lcom/mopub/nativeads/VisibilityTracker;->mAccessCounter:J

    iput-wide v2, v1, Lcom/mopub/nativeads/VisibilityTracker$TrackingInfo;->mAccessOrder:J
    ...
    iput-wide v2, p0, Lcom/mopub/nativeads/VisibilityTracker;->mAccessCounter:J
    ...
    invoke-direct {p0, v2, v3}, Lcom/mopub/nativeads/VisibilityTracker;->trimTrackedViews(J)V
...
.method destroy()V
    ...
    .line 206
    iget-object v1, p0, Lcom/mopub/nativeads/VisibilityTracker;->mWeakViewTreeObserver:Ljava/lang/ref/WeakReference;
...
.method setVisibilityTrackerListener(Lcom/mopub/nativeads/VisibilityTracker$VisibilityTrackerListener;)V
    .locals 0
    .param p1, "visibilityTrackerListener"    # Lcom/mopub/nativeads/VisibilityTracker$VisibilityTrackerListener;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
