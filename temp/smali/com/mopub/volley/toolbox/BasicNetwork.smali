...
.method public constructor <init>(Lcom/mopub/volley/toolbox/HttpStack;)V
    .locals 2
    .param p1, "httpStack"    # Lcom/mopub/volley/toolbox/HttpStack;
...
.method public constructor <init>(Lcom/mopub/volley/toolbox/HttpStack;Lcom/mopub/volley/toolbox/ByteArrayPool;)V
    .locals 0
    .param p1, "httpStack"    # Lcom/mopub/volley/toolbox/HttpStack;
    .param p2, "pool"    # Lcom/mopub/volley/toolbox/ByteArrayPool;
...
.method private static attemptRetryOnException(Ljava/lang/String;Lcom/mopub/volley/Request;Lcom/mopub/volley/VolleyError;)V
    ...
    .param p2, "exception"    # Lcom/mopub/volley/VolleyError;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
    ...
    .line 193
    .local v2, "retryPolicy":Lcom/mopub/volley/RetryPolicy;
    ...
    :try_start_0
    invoke-interface {v2, p2}, Lcom/mopub/volley/RetryPolicy;->retry(Lcom/mopub/volley/VolleyError;)V
    :try_end_0
...
.method private entityToBytes(Lorg/apache/http/HttpEntity;)[B
    ...
    .line 228
    new-instance v1, Lcom/mopub/volley/toolbox/PoolingByteArrayOutputStream;

    iget-object v5, p0, Lcom/mopub/volley/toolbox/BasicNetwork;->mPool:Lcom/mopub/volley/toolbox/ByteArrayPool;
    ...
    invoke-direct {v1, v5, v6}, Lcom/mopub/volley/toolbox/PoolingByteArrayOutputStream;-><init>(Lcom/mopub/volley/toolbox/ByteArrayPool;I)V

    .line 230
    .local v1, "bytes":Lcom/mopub/volley/toolbox/PoolingByteArrayOutputStream;
    const/4 v0, 0x0
    ...
    .line 234
    new-instance v5, Lcom/mopub/volley/ServerError;

    invoke-direct {v5}, Lcom/mopub/volley/ServerError;-><init>()V
    ...
    .line 251
    :goto_0
    iget-object v6, p0, Lcom/mopub/volley/toolbox/BasicNetwork;->mPool:Lcom/mopub/volley/toolbox/ByteArrayPool;

    invoke-virtual {v6, v0}, Lcom/mopub/volley/toolbox/ByteArrayPool;->returnBuf([B)V

    .line 252
    invoke-virtual {v1}, Lcom/mopub/volley/toolbox/PoolingByteArrayOutputStream;->close()V
    ...
    invoke-virtual {v5, v6}, Lcom/mopub/volley/toolbox/ByteArrayPool;->getBuf(I)[B
    ...
    invoke-virtual {v1, v0, v5, v2}, Lcom/mopub/volley/toolbox/PoolingByteArrayOutputStream;->write([BII)V

    goto :goto_1

    .line 241
    :cond_1
    invoke-virtual {v1}, Lcom/mopub/volley/toolbox/PoolingByteArrayOutputStream;->toByteArray()[B
    :try_end_2
    ...
    invoke-static {v6, v7}, Lcom/mopub/volley/VolleyLog;->v(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private logSlowRequests(JLcom/mopub/volley/Request;[BLorg/apache/http/StatusLine;)V
    ...
    .prologue
    .line 177
    .local p3, "request":Lcom/mopub/volley/Request;, "Lcom/mopub/volley/Request<*>;"
...
.method public performRequest(Lcom/mopub/volley/Request;)Lcom/mopub/volley/NetworkResponse;
    ...
    invoke-direct {v0, v1, v3}, Lcom/mopub/volley/toolbox/BasicNetwork;->addCacheHeaders(Ljava/util/Map;Lcom/mopub/volley/Cache$Entry;)V

    .line 96
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/mopub/volley/toolbox/BasicNetwork;->mHttpStack:Lcom/mopub/volley/toolbox/HttpStack;

    move-object/from16 v0, p1

    move-object/from16 v1, v21

    invoke-interface {v3, v0, v1}, Lcom/mopub/volley/toolbox/HttpStack;->performRequest(Lcom/mopub/volley/Request;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    ...
    invoke-static {v3}, Lcom/mopub/volley/toolbox/BasicNetwork;->convertHeaders([Lorg/apache/http/Header;)Ljava/util/Map;
    ...
    .line 105
    .local v20, "entry":Lcom/mopub/volley/Cache$Entry;
    if-nez v20, :cond_0
    ...
    .end local v20    # "entry":Lcom/mopub/volley/Cache$Entry;
    ...
    .restart local v20    # "entry":Lcom/mopub/volley/Cache$Entry;
    .restart local v23    # "responseContents":[B
    :cond_0
    move-object/from16 v0, v20

    iget-object v3, v0, Lcom/mopub/volley/Cache$Entry;->responseHeaders:Ljava/util/Map;
    ...
    iget-object v9, v0, Lcom/mopub/volley/Cache$Entry;->data:[B

    move-object/from16 v0, v20

    iget-object v10, v0, Lcom/mopub/volley/Cache$Entry;->responseHeaders:Ljava/util/Map;
    ...
    invoke-direct {v0, v3}, Lcom/mopub/volley/toolbox/BasicNetwork;->entityToBytes(Lorg/apache/http/HttpEntity;)[B
    :try_end_0
    ...
    new-instance v4, Lcom/mopub/volley/TimeoutError;

    invoke-direct {v4}, Lcom/mopub/volley/TimeoutError;-><init>()V

    move-object/from16 v0, p1

    invoke-static {v3, v0, v4}, Lcom/mopub/volley/toolbox/BasicNetwork;->attemptRetryOnException(Ljava/lang/String;Lcom/mopub/volley/Request;Lcom/mopub/volley/VolleyError;)V
    ...
    :cond_4
    :try_start_3
    new-instance v13, Lcom/mopub/volley/NetworkResponse;
    ...
    invoke-direct/range {v13 .. v19}, Lcom/mopub/volley/NetworkResponse;-><init>(I[BLjava/util/Map;ZJ)V
    :try_end_3
    ...
    .line 148
    .local v13, "networkResponse":Lcom/mopub/volley/NetworkResponse;
    if-eqz v22, :cond_6
    ...
    invoke-static {v3, v4}, Lcom/mopub/volley/VolleyLog;->e(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .end local v13    # "networkResponse":Lcom/mopub/volley/NetworkResponse;
    const/16 v17, 0x0
    ...
    .line 157
    .restart local v13    # "networkResponse":Lcom/mopub/volley/NetworkResponse;
    const/16 v3, 0x191
    ...
    invoke-direct {v4, v13}, Lcom/mopub/volley/AuthFailureError;-><init>(Lcom/mopub/volley/NetworkResponse;)V
    ...
    invoke-direct {v3, v13}, Lcom/mopub/volley/ServerError;-><init>(Lcom/mopub/volley/NetworkResponse;)V
    ...
    invoke-direct {v3, v13}, Lcom/mopub/volley/NetworkError;-><init>(Lcom/mopub/volley/NetworkResponse;)V
