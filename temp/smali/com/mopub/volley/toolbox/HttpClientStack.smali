...
.method public constructor <init>(Lorg/apache/http/client/HttpClient;)V
    ...
    .line 56
    iput-object p1, p0, Lcom/mopub/volley/toolbox/HttpClientStack;->mClient:Lorg/apache/http/client/HttpClient;
...
.method static createHttpRequest(Lcom/mopub/volley/Request;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 96
    .local p0, "request":Lcom/mopub/volley/Request;, "Lcom/mopub/volley/Request<*>;"
    ...
    .line 120
    invoke-static {v3, p0}, Lcom/mopub/volley/toolbox/HttpClientStack;->setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lcom/mopub/volley/Request;)V
    ...
    .line 126
    invoke-static {v4, p0}, Lcom/mopub/volley/toolbox/HttpClientStack;->setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lcom/mopub/volley/Request;)V
    ...
    .line 136
    :pswitch_8
    new-instance v1, Lcom/mopub/volley/toolbox/HttpClientStack$HttpPatch;

    invoke-virtual {p0}, Lcom/mopub/volley/Request;->getUrl()Ljava/lang/String;

    move-result-object v5

    invoke-direct {v1, v5}, Lcom/mopub/volley/toolbox/HttpClientStack$HttpPatch;-><init>(Ljava/lang/String;)V

    .line 137
    .local v1, "patchRequest":Lcom/mopub/volley/toolbox/HttpClientStack$HttpPatch;
    const-string v5, "Content-Type"
    ...
    invoke-virtual {v1, v5, v6}, Lcom/mopub/volley/toolbox/HttpClientStack$HttpPatch;->addHeader(Ljava/lang/String;Ljava/lang/String;)V

    .line 138
    invoke-static {v1, p0}, Lcom/mopub/volley/toolbox/HttpClientStack;->setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lcom/mopub/volley/Request;)V
...
.method private static setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lcom/mopub/volley/Request;)V
    .locals 2
...
.method public performRequest(Lcom/mopub/volley/Request;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    ...
    invoke-static {p1, p2}, Lcom/mopub/volley/toolbox/HttpClientStack;->createHttpRequest(Lcom/mopub/volley/Request;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;

    move-result-object v1

    .line 78
    .local v1, "httpRequest":Lorg/apache/http/client/methods/HttpUriRequest;
    invoke-static {v1, p2}, Lcom/mopub/volley/toolbox/HttpClientStack;->addHeaders(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V
    ...
    invoke-static {v1, v3}, Lcom/mopub/volley/toolbox/HttpClientStack;->addHeaders(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V

    .line 80
    invoke-virtual {p0, v1}, Lcom/mopub/volley/toolbox/HttpClientStack;->onPrepareRequest(Lorg/apache/http/client/methods/HttpUriRequest;)V
    ...
    .line 87
    iget-object v3, p0, Lcom/mopub/volley/toolbox/HttpClientStack;->mClient:Lorg/apache/http/client/HttpClient;
