...
.method constructor <init>(Lcom/mopub/common/event/EventSampler;Ljava/util/Queue;Lcom/mopub/common/event/EventSerializer;Lcom/mopub/network/ScribeRequestManager;Landroid/os/Handler;)V
    .locals 1
    .param p1, "eventSampler"    # Lcom/mopub/common/event/EventSampler;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    .param p2    # Ljava/util/Queue;
        ...
        .end annotation
    .end param
    .param p3, "eventSerializer"    # Lcom/mopub/common/event/EventSerializer;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    .param p4, "scribeRequestManager"    # Lcom/mopub/network/ScribeRequestManager;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    ...
    .prologue
    .line 59
    .local p2, "eventQueue":Ljava/util/Queue;, "Ljava/util/Queue<Lcom/mopub/common/event/BaseEvent;>;"
...
.method static synthetic access$000(Lcom/mopub/common/event/ScribeEventRecorder;)Lcom/mopub/common/event/EventSerializer;
    .locals 1
    .param p0, "x0"    # Lcom/mopub/common/event/ScribeEventRecorder;
...
.method dequeueEvents()Ljava/util/List;
    ...
    .line 117
    .local v0, "baseEvents":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/mopub/common/event/BaseEvent;>;"
    :goto_0
...
.method public record(Lcom/mopub/common/event/BaseEvent;)V
    .locals 2
    .param p1, "baseEvent"    # Lcom/mopub/common/event/BaseEvent;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
...
.method sendEvents()V
    ...
    invoke-virtual {v1}, Lcom/mopub/network/ScribeRequestManager;->isAtCapacity()Z
    ...
    .line 95
    .local v0, "events":Ljava/util/List;, "Ljava/util/List<Lcom/mopub/common/event/BaseEvent;>;"
    ...
    new-instance v3, Lcom/mopub/network/ScribeBackoffPolicy;

    invoke-direct {v3}, Lcom/mopub/network/ScribeBackoffPolicy;-><init>()V

    invoke-virtual {v1, v2, v3}, Lcom/mopub/network/ScribeRequestManager;->makeRequest(Lcom/mopub/network/RequestManager$RequestFactory;Lcom/mopub/network/BackoffPolicy;)V
