...
.method static synthetic access$000(Lcom/mopub/network/MoPubRequestQueue;)Ljava/util/Map;
    .locals 1
    .param p0, "x0"    # Lcom/mopub/network/MoPubRequestQueue;
...
.method addDelayedRequest(Lcom/mopub/volley/Request;Lcom/mopub/network/MoPubRequestQueue$DelayedRequestHelper;)V
    ...
    .param p1    # Lcom/mopub/volley/Request;
        ...
        .end annotation
    .end param
    .param p2, "delayedRequestHelper"    # Lcom/mopub/network/MoPubRequestQueue$DelayedRequestHelper;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
...
.method public cancelAll(Lcom/mopub/volley/RequestQueue$RequestFilter;)V
    ...
    .line 80
    iget-object v2, p0, Lcom/mopub/network/MoPubRequestQueue;->mDelayedRequests:Ljava/util/Map;
    ...
    .line 81
    .local v1, "iterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Lcom/mopub/volley/Request<*>;Lcom/mopub/network/MoPubRequestQueue$DelayedRequestHelper;>;>;"
    :cond_0
    :goto_0
    ...
    .line 83
    .local v0, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/mopub/volley/Request<*>;Lcom/mopub/network/MoPubRequestQueue$DelayedRequestHelper;>;"
    ...
    check-cast v2, Lcom/mopub/network/MoPubRequestQueue$DelayedRequestHelper;

    invoke-virtual {v2}, Lcom/mopub/network/MoPubRequestQueue$DelayedRequestHelper;->cancel()V
    ...
    .line 90
    .end local v0    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/mopub/volley/Request<*>;Lcom/mopub/network/MoPubRequestQueue$DelayedRequestHelper;>;"
    :cond_1
    return-void
.end method
