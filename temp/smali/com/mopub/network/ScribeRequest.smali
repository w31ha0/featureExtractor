...
.method public constructor <init>(Ljava/lang/String;Ljava/util/List;Lcom/mopub/common/event/EventSerializer;Lcom/mopub/network/ScribeRequest$Listener;)V
    ...
    .param p3, "eventSerializer"    # Lcom/mopub/common/event/EventSerializer;
        ...
        .end annotation
    .end param
    .param p4, "listener"    # Lcom/mopub/network/ScribeRequest$Listener;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
    ...
    .prologue
    .line 41
    .local p2, "events":Ljava/util/List;, "Ljava/util/List<Lcom/mopub/common/event/BaseEvent;>;"
    const/4 v0, 0x1
...
.method protected getParams()Ljava/util/Map;
    ...
    .prologue
    .line 58
    iget-object v2, p0, Lcom/mopub/network/ScribeRequest;->mEventSerializer:Lcom/mopub/common/event/EventSerializer;

    iget-object v3, p0, Lcom/mopub/network/ScribeRequest;->mEvents:Ljava/util/List;

    invoke-virtual {v2, v3}, Lcom/mopub/common/event/EventSerializer;->serializeAsJson(Ljava/util/List;)Lorg/json/JSONArray;
