...
.method private constructor <init>(Ljava/lang/String;Lcom/mopub/network/TrackingRequest$Listener;)V
    ...
    .param p1, "url"    # Ljava/lang/String;
        ...
        .end annotation
    .end param
    .param p2, "listener"    # Lcom/mopub/network/TrackingRequest$Listener;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
...
.method public static makeTrackingHttpRequest(Ljava/lang/Iterable;Landroid/content/Context;)V
    ...
    .prologue
    .local p0, "urls":Ljava/lang/Iterable;, "Ljava/lang/Iterable<Ljava/lang/String;>;"
    const/4 v0, 0x0
...
.method public static makeTrackingHttpRequest(Ljava/lang/Iterable;Landroid/content/Context;Lcom/mopub/common/event/BaseEvent$Name;)V
    ...
    .param p1, "context"    # Landroid/content/Context;
        ...
        .end annotation
    .end param
    .param p2, "name"    # Lcom/mopub/common/event/BaseEvent$Name;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/Iterable",
...
.method public static makeTrackingHttpRequest(Ljava/lang/Iterable;Landroid/content/Context;Lcom/mopub/network/TrackingRequest$Listener;Lcom/mopub/common/event/BaseEvent$Name;)V
    ...
    .param p2, "listener"    # Lcom/mopub/network/TrackingRequest$Listener;
        ...
        .end annotation
    .end param
    .param p3, "name"    # Lcom/mopub/common/event/BaseEvent$Name;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/Iterable",
    ...
    .line 108
    .local v1, "requestQueue":Lcom/mopub/volley/RequestQueue;
    ...
    invoke-direct {v0, p2, v3}, Lcom/mopub/network/TrackingRequest$1;-><init>(Lcom/mopub/network/TrackingRequest$Listener;Ljava/lang/String;)V

    .line 130
    .local v0, "internalListener":Lcom/mopub/network/TrackingRequest$Listener;
    new-instance v2, Lcom/mopub/network/TrackingRequest;

    invoke-direct {v2, v3, v0}, Lcom/mopub/network/TrackingRequest;-><init>(Ljava/lang/String;Lcom/mopub/network/TrackingRequest$Listener;)V

    .line 131
    .local v2, "trackingRequest":Lcom/mopub/network/TrackingRequest;
    invoke-virtual {v1, v2}, Lcom/mopub/volley/RequestQueue;->add(Lcom/mopub/volley/Request;)Lcom/mopub/volley/Request;
...
.method public static makeVastTrackingHttpRequest(Ljava/util/List;Lcom/mopub/mobileads/VastErrorCode;Ljava/lang/Integer;Ljava/lang/String;Landroid/content/Context;)V
    ...
    .param p0    # Ljava/util/List;
        ...
        .end annotation
    .end param
    .param p1, "vastErrorCode"    # Lcom/mopub/mobileads/VastErrorCode;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
    .param p2, "contentPlayHead"    # Ljava/lang/Integer;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
    .param p3, "assetUri"    # Ljava/lang/String;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
    ...
    .prologue
    .line 75
    .local p0, "vastTrackers":Ljava/util/List;, "Ljava/util/List<Lcom/mopub/mobileads/VastTracker;>;"
    ...
    .line 78
    .local v0, "trackers":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 79
    .local v1, "vastTracker":Lcom/mopub/mobileads/VastTracker;
    if-eqz v1, :cond_0
    ...
    .line 89
    .end local v1    # "vastTracker":Lcom/mopub/mobileads/VastTracker;
    :cond_2
    ...
    .line 91
    invoke-virtual {v2, p1}, Lcom/mopub/mobileads/VastMacroHelper;->withErrorCode(Lcom/mopub/mobileads/VastErrorCode;)Lcom/mopub/mobileads/VastMacroHelper;

    move-result-object v2

    .line 92
    invoke-virtual {v2, p2}, Lcom/mopub/mobileads/VastMacroHelper;->withContentPlayHead(Ljava/lang/Integer;)Lcom/mopub/mobileads/VastMacroHelper;

    move-result-object v2

    .line 93
    invoke-virtual {v2, p3}, Lcom/mopub/mobileads/VastMacroHelper;->withAssetUri(Ljava/lang/String;)Lcom/mopub/mobileads/VastMacroHelper;

    move-result-object v2

    .line 94
    invoke-virtual {v2}, Lcom/mopub/mobileads/VastMacroHelper;->getUris()Ljava/util/List;

    move-result-object v2

    .line 89
    invoke-static {v2, p4}, Lcom/mopub/network/TrackingRequest;->makeTrackingHttpRequest(Ljava/lang/Iterable;Landroid/content/Context;)V
