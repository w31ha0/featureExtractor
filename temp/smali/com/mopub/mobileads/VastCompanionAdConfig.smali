...
.method public constructor <init>(IILcom/mopub/mobileads/VastResource;Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
    ...
    .param p1, "width"    # I
    .param p2, "height"    # I
    .param p3, "vastResource"    # Lcom/mopub/mobileads/VastResource;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    ...
    .prologue
    .line 40
    .local p5, "clickTrackers":Ljava/util/List;, "Ljava/util/List<Lcom/mopub/mobileads/VastTracker;>;"
    .local p6, "creativeViewTrackers":Ljava/util/List;, "Ljava/util/List<Lcom/mopub/mobileads/VastTracker;>;"
...
.method public addCreativeViewTrackers(Ljava/util/List;)V
    ...
    .prologue
    .line 69
    .local p1, "creativeViewTrackers":Ljava/util/List;, "Ljava/util/List<Lcom/mopub/mobileads/VastTracker;>;"
    const-string v0, "creativeViewTrackers cannot be null"
...
.method handleClick(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;)V
    ...
    .param p3, "webViewClickThroughUrl"    # Ljava/lang/String;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
    .param p4, "dspCreativeId"    # Ljava/lang/String;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
    ...
    invoke-static {v1, v2}, Lcom/mopub/common/Preconditions;->checkArgument(ZLjava/lang/String;)V

    .line 136
    iget-object v1, p0, Lcom/mopub/mobileads/VastCompanionAdConfig;->mVastResource:Lcom/mopub/mobileads/VastResource;

    iget-object v2, p0, Lcom/mopub/mobileads/VastCompanionAdConfig;->mClickThroughUrl:Ljava/lang/String;

    invoke-virtual {v1, v2, p3}, Lcom/mopub/mobileads/VastResource;->getCorrectClickThroughUrl(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    .line 139
    .local v0, "correctClickThroughUrl":Ljava/lang/String;
