...
.method static synthetic access$000(Lcom/mopub/mobileads/MoPubInterstitial;)Lcom/mopub/mobileads/MoPubInterstitial$InterstitialState;
    .locals 1
    .param p0, "x0"    # Lcom/mopub/mobileads/MoPubInterstitial;
...
.method static synthetic access$202(Lcom/mopub/mobileads/MoPubInterstitial;Lcom/mopub/mobileads/CustomEventInterstitialAdapter;)Lcom/mopub/mobileads/CustomEventInterstitialAdapter;
    .locals 0
    .param p0, "x0"    # Lcom/mopub/mobileads/MoPubInterstitial;
    .param p1, "x1"    # Lcom/mopub/mobileads/CustomEventInterstitialAdapter;
...
.method static synthetic access$300(Lcom/mopub/mobileads/MoPubInterstitial;Lcom/mopub/mobileads/MoPubInterstitial$InterstitialState;)Z
    .locals 1
    .param p0, "x0"    # Lcom/mopub/mobileads/MoPubInterstitial;
    .param p1, "x1"    # Lcom/mopub/mobileads/MoPubInterstitial$InterstitialState;
...
.method private attemptStateTransition(Lcom/mopub/mobileads/MoPubInterstitial$InterstitialState;)Z
    .locals 1
    .param p1, "endState"    # Lcom/mopub/mobileads/MoPubInterstitial$InterstitialState;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
...
.method declared-synchronized attemptStateTransition(Lcom/mopub/mobileads/MoPubInterstitial$InterstitialState;Z)Z
    ...
    .line 126
    .local v0, "startState":Lcom/mopub/mobileads/MoPubInterstitial$InterstitialState;
    ...
    iput-object v2, p0, Lcom/mopub/mobileads/MoPubInterstitial;->mCurrentInterstitialState:Lcom/mopub/mobileads/MoPubInterstitial$InterstitialState;
    ...
    invoke-virtual {v2}, Lcom/mopub/mobileads/MoPubInterstitial$MoPubInterstitialView;->forceRefresh()V
    :try_end_1
    ...
    .line 114
    .end local v0    # "startState":Lcom/mopub/mobileads/MoPubInterstitial$InterstitialState;
    :catchall_0
    move-exception v1
    ...
    .line 138
    .restart local v0    # "startState":Lcom/mopub/mobileads/MoPubInterstitial$InterstitialState;
    :cond_1
    :try_start_2
    iget-object v2, p0, Lcom/mopub/mobileads/MoPubInterstitial;->mInterstitialView:Lcom/mopub/mobileads/MoPubInterstitial$MoPubInterstitialView;

    invoke-virtual {v2}, Lcom/mopub/mobileads/MoPubInterstitial$MoPubInterstitialView;->loadAd()V

    goto :goto_0

    .line 142
    :pswitch_2
    const-string v1, "No interstitial loading or loaded."
    ...
    .line 162
    const-string v1, "Already loading an interstitial."
    ...
    .line 170
    invoke-virtual {v2}, Lcom/mopub/mobileads/MoPubInterstitial$MoPubInterstitialView;->getCustomEventClassName()Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Lcom/mopub/mobileads/AdTypeTranslator$CustomEventType;->isMoPubSpecific(Ljava/lang/String;)Z
    ...
    .line 171
    iget-object v2, p0, Lcom/mopub/mobileads/MoPubInterstitial;->mHandler:Landroid/os/Handler;

    iget-object v3, p0, Lcom/mopub/mobileads/MoPubInterstitial;->mAdExpiration:Ljava/lang/Runnable;
    ...
    .line 175
    :pswitch_8
    const-string v1, "Interstitial is not ready to be shown yet."
    ...
    .line 195
    :pswitch_c
    const-string v1, "Interstitial already loaded. Not loading another."

    invoke-static {v1}, Lcom/mopub/common/logging/MoPubLog;->d(Ljava/lang/String;)V

    .line 197
    iget-object v1, p0, Lcom/mopub/mobileads/MoPubInterstitial;->mInterstitialAdListener:Lcom/mopub/mobileads/MoPubInterstitial$InterstitialAdListener;
    ...
    invoke-interface {v1, p0}, Lcom/mopub/mobileads/MoPubInterstitial$InterstitialAdListener;->onInterstitialLoaded(Lcom/mopub/mobileads/MoPubInterstitial;)V
    ...
    .line 217
    const-string v1, "Cannot force refresh while showing an interstitial."
    ...
    .line 226
    const-string v1, "Interstitial already showing. Not loading another."
    ...
    .line 230
    :pswitch_12
    const-string v1, "Already showing an interstitial. Cannot show it again."
    ...
    .line 240
    :pswitch_14
    const-string v1, "MoPubInterstitial destroyed. Ignoring all requests."
...
.method setCurrentInterstitialState(Lcom/mopub/mobileads/MoPubInterstitial$InterstitialState;)V
    .locals 0
    .param p1, "interstitialState"    # Lcom/mopub/mobileads/MoPubInterstitial$InterstitialState;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Lcom/mopub/common/VisibleForTesting;
...
.method setCustomEventInterstitialAdapter(Lcom/mopub/mobileads/CustomEventInterstitialAdapter;)V
    .locals 0
    .param p1, "customEventInterstitialAdapter"    # Lcom/mopub/mobileads/CustomEventInterstitialAdapter;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Lcom/mopub/common/VisibleForTesting;
...
.method public setInterstitialAdListener(Lcom/mopub/mobileads/MoPubInterstitial$InterstitialAdListener;)V
    .locals 0
    .param p1, "listener"    # Lcom/mopub/mobileads/MoPubInterstitial$InterstitialAdListener;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param
...
.method setInterstitialView(Lcom/mopub/mobileads/MoPubInterstitial$MoPubInterstitialView;)V
    .locals 0
    .param p1, "interstitialView"    # Lcom/mopub/mobileads/MoPubInterstitial$MoPubInterstitialView;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Lcom/mopub/common/VisibleForTesting;
